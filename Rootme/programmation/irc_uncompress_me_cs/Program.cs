...
namespace IRC_Chaine_Encodee
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string res = uncompress_me("eJxzrHItCqn0zC8AABBiA2g=");
            ...
            try
            {
                ...
                while ((inputLine = reader.ReadLine()) != null)
                {
                    ...
                    else if (inputLine.Contains("PRIVMSG Louis") && respond)
                    {
                        ...
                        writer.WriteLine("privmsg Candy !ep2 -rep " + uncompress_me(encrypted));
                        writer.Flush();
        ...
        public static string uncompress_me(string encrypted)
        {
